...
define([
     ...
     * 服务初始化
     */
    RdThemeService.prototype.init = function () {
        //中间图层初始化
        //1、临时巡护区图层
     ...
     * 关闭专题时调用
     */
    RdThemeService.prototype.onClose = function () {
        //清空临时状态与对象
        this.clearTmp();
    };
     ...
     * 清除临时状态或图形
     */
    RdThemeService.prototype.clearTmp = function () {
        //停止播放轨迹、选中
        this.cancelSelected();
        this.trackPlayClose();
     ...
     * @param gjItem
     */
    RdThemeService.prototype.showGj = function (gjItem) {
        //检查是否已有显示
     ...
     * 关闭某条轨迹
     */
    RdThemeService.prototype.closeGj = function (lineId) {
     ...
     * @param gjItem
     */
    RdThemeService.prototype.trackPlayInit = function (gjItem) {
        var dataSource = this._gjTmpLayer.getSource();
     ...
     */
    RdThemeService.prototype.trackPlay = function (fraction) {
        //默认已经初始化了
        if (this._trackSimulate) {
     ...
     * 关闭轨迹演示模拟
     */
    RdThemeService.prototype.trackPlayClose = function () {
        //模拟器删除
        if (this._trackSimulate) {
     ...
     */
    RdThemeService.prototype.showXhq = function (patrolDetail) {
        //显示当前巡护区
     ...
     * @param patrolPoint
     */
    RdThemeService.prototype.selectKeyPoint = function (patrolPoint) {
     ...
     * （从UI）取消选择关键点
     */
    RdThemeService.prototype.unSelectKeyPoint = function () {
        var tmpSource = this._gjdTmpLayer.getSource();
     ...
     * 关闭某个巡护区显示
     */
    RdThemeService.prototype.closeXhq = function (zoneId) {
     ...
     * @private
     */
    RdThemeService.prototype._getTmpLayer = function () {
        if (!this._tmpLayer) {
    ...
    RdThemeService.prototype._getLayerDataSource = function () {
        if (!this._LayerDataSource) {
            this._LayerDataSource = this._layerManage.rdLayer.getSource();
        }
     ...
     * @private
     */
    RdThemeService.prototype._showKeyPoints = function (zoneItem, patrolPoints) {
        var tmpSource = this._gjdTmpLayer.getSource();
     ...
     * @private
     */
    RdThemeService.prototype._addStartAndEndPoint = function (lineItem, startGpsInfo, endGpsInfo) {
